...
public class FlexibleSearchFromTableImpl extends ASTWrapperPsiElement implements FlexibleSearchFromTable {

  public FlexibleSearchFromTableImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public FlexibleSearchDefinedTableName getDefinedTableName() {
    return findNotNullChildByClass(FlexibleSearchDefinedTableName.class);
  }

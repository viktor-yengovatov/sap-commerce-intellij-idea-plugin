...
public class AclUserRightsHeaderParameterTypeImpl extends ASTWrapperPsiElement implements AclUserRightsHeaderParameterType {

  public AclUserRightsHeaderParameterTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AclVisitor visitor) {
    visitor.visitUserRightsHeaderParameterType(this);
  }

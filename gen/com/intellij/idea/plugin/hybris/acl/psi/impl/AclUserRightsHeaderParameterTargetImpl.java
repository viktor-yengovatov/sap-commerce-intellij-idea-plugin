...
public class AclUserRightsHeaderParameterTargetImpl extends ASTWrapperPsiElement implements AclUserRightsHeaderParameterTarget {

  public AclUserRightsHeaderParameterTargetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AclVisitor visitor) {
    visitor.visitUserRightsHeaderParameterTarget(this);
  }

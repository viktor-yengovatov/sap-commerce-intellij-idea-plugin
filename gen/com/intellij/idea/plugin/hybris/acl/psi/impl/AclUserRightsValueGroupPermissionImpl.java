...
public class AclUserRightsValueGroupPermissionImpl extends ASTWrapperPsiElement implements AclUserRightsValueGroupPermission {

  public AclUserRightsValueGroupPermissionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AclVisitor visitor) {
    visitor.visitUserRightsValueGroupPermission(this);
  }

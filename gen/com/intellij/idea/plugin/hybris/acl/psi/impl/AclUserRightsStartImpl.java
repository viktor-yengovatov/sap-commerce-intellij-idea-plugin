...
public class AclUserRightsStartImpl extends ASTWrapperPsiElement implements AclUserRightsStart {

  public AclUserRightsStartImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AclVisitor visitor) {
    visitor.visitUserRightsStart(this);
  }

...
public class AclUserRightsValueGroupBlankImpl extends ASTWrapperPsiElement implements AclUserRightsValueGroupBlank {

  public AclUserRightsValueGroupBlankImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AclVisitor visitor) {
    visitor.visitUserRightsValueGroupBlank(this);
  }

...
public class AclUserRightsValueGroupsImpl extends ASTWrapperPsiElement implements AclUserRightsValueGroups {

  public AclUserRightsValueGroupsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AclVisitor visitor) {
    visitor.visitUserRightsValueGroups(this);
  }

...
public class AclUserRightsHeaderParameterPasswordImpl extends ASTWrapperPsiElement implements AclUserRightsHeaderParameterPassword {

  public AclUserRightsHeaderParameterPasswordImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AclVisitor visitor) {
    visitor.visitUserRightsHeaderParameterPassword(this);
  }

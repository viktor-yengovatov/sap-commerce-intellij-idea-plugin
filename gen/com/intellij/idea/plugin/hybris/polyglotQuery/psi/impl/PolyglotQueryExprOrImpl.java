...
public class PolyglotQueryExprOrImpl extends ASTWrapperPsiElement implements PolyglotQueryExprOr {

  public PolyglotQueryExprOrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PolyglotQueryVisitor visitor) {
    visitor.visitExprOr(this);
  }
  ...
  @Override
  @NotNull
  public List<PolyglotQueryExprAnd> getExprAndList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PolyglotQueryExprAnd.class);
  }

...
public class PolyglotQueryOrderByImpl extends ASTWrapperPsiElement implements PolyglotQueryOrderBy {

  public PolyglotQueryOrderByImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PolyglotQueryOrderKey> getOrderKeyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PolyglotQueryOrderKey.class);
  }

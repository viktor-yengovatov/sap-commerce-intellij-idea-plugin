...
public class PolyglotQueryNullOperatorImpl extends ASTWrapperPsiElement implements PolyglotQueryNullOperator {

  public PolyglotQueryNullOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PolyglotQueryVisitor visitor) {
    visitor.visitNullOperator(this);
  }

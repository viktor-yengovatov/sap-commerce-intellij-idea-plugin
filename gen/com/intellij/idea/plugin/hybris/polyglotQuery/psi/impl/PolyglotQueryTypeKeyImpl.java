...
public class PolyglotQueryTypeKeyImpl extends ASTWrapperPsiElement implements PolyglotQueryTypeKey {

  public PolyglotQueryTypeKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PolyglotQueryVisitor visitor) {
    visitor.visitTypeKey(this);
  }

...
public class PolyglotQueryCmpOperatorImpl extends ASTWrapperPsiElement implements PolyglotQueryCmpOperator {

  public PolyglotQueryCmpOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PolyglotQueryVisitor visitor) {
    visitor.visitCmpOperator(this);
  }

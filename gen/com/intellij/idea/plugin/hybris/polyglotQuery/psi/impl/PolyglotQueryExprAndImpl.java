...
public class PolyglotQueryExprAndImpl extends ASTWrapperPsiElement implements PolyglotQueryExprAnd {

  public PolyglotQueryExprAndImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PolyglotQueryVisitor visitor) {
    visitor.visitExprAnd(this);
  }
  ...
  @Override
  @NotNull
  public List<PolyglotQueryExprAtom> getExprAtomList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PolyglotQueryExprAtom.class);
  }

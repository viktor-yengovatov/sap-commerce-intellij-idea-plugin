...
public class PolyglotQueryOrderKeyImpl extends ASTWrapperPsiElement implements PolyglotQueryOrderKey {

  public PolyglotQueryOrderKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PolyglotQueryVisitor visitor) {
    visitor.visitOrderKey(this);
  }
  ...
  public PolyglotQueryAttributeKey getAttributeKey() {
    return findNotNullChildByClass(PolyglotQueryAttributeKey.class);
  }

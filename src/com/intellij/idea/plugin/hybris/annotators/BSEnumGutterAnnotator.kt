 ...
 */
package com.intellij.idea.plugin.hybris.annotators
...
class BSEnumGutterAnnotator : Annotator {
    ...
    private fun findAlternativeDoms(sourceDom: Enum, project: Project) = BSMetaModelAccess.getInstance(project).findMetaForDom(sourceDom)?.retrieveAllDoms()

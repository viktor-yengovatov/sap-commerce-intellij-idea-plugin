...
import com.intellij.idea.plugin.hybris.beans.meta.BeansMetaModelProcessor
...
class BeansMetaModelProcessorImpl(private val myProject: Project) : BeansMetaModelProcessor {
    private val myDomManager: DomManager = DomManager.getDomManager(myProject)

    override fun process(psiFile: PsiFile): BeansMetaModel? {
        psiFile.virtualFile ?: return null
        val module = BeansUtils.getModuleForFile(psiFile) ?: return null
        val custom = BeansUtils.isCustomExtensionFile(psiFile)

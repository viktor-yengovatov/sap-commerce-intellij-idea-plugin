...
interface BeansMetaClassifier<DOM : DomElement> {
...
interface BeansGlobalMetaClassifier<DOM : DomElement> : BeansMetaClassifier<DOM> {
    val declarations: MutableSet<out BeansMetaClassifier<DOM>>

...
import com.intellij.idea.plugin.hybris.beans.meta.BeansMetaModelCollector
...
class BeansMetaModelCollectorImpl(private val myProject: Project) : BeansMetaModelCollector {
                    ...
                    StubIndex.getInstance().processElements(
                        ...
                        object : Processor<PsiFile> {
                            override fun process(psiFile: PsiFile): Boolean {
                                ...
                                BeansUtils.getModuleForFile(psiFile) ?: return true

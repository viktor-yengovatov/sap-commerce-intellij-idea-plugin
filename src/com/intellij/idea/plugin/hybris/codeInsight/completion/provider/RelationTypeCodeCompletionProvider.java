...
public class RelationTypeCodeCompletionProvider extends CompletionProvider<CompletionParameters> {

    @NotNull
    public static CompletionProvider<CompletionParameters> getInstance() {
        return ApplicationManager.getApplication().getService(RelationTypeCodeCompletionProvider.class);
    }
    ...
    public void addCompletions(
        ...
        TSMetaModelAccess.Companion.getInstance(project).<TSGlobalMetaRelation>getAll(TSMetaType.META_RELATION).stream()

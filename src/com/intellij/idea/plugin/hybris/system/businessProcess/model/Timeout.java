...
/**
 * http://www.hybris.de/xsd/processdefinition:timeout interface.
 * <pre>
 * <h3>Type http://www.hybris.de/xsd/processdefinition:timeout documentation</h3>
...
public interface Timeout extends DomElement {
	 ...
	 * <pre>
	 * <h3>Attribute null:delay documentation</h3>
	 * Delay after which wait will be timed out
	 * </pre>
	 ...
	 * <pre>
	 * <h3>Attribute null:then documentation</h3>

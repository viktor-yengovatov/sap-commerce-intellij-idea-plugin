...
class DtoBeanLineMarkerProvider : AbstractHybrisClassLineMarkerProvider<PsiClass>() {
    ...
    override fun getName() = message("hybris.editor.gutter.bs.dto.bean.name")
    override fun getIcon(): Icon = HybrisIcons.BS_BEAN
    ...
    override fun collectDeclarations(psi: PsiClass) = BSMetaModelAccess.getInstance(psi.project).findMetaBeansByName(psi.qualifiedName!!)
        ...
        ?.let {
            NavigationGutterIconBuilder
                .create(icon)
                .setTargets(it)
                .setPopupTitle(message("hybris.editor.gutter.bs.dto.bean.popup.title"))
                .setTooltipText(message("hybris.editor.gutter.bs.dto.bean.tooltip.text"))

...
class ItemTypeReferenceConverter : CustomReferenceConverter<String>, ResolvingHint {

    override fun createReferences(value: GenericDomValue<String>?, element: PsiElement, context: ConvertContext?) = arrayOf(ItemReference(element))

...
class CollectionTypeConverter : TSConverterBase<CollectionType>(CollectionType::class.java) {
    ...
    override fun createLookupElement(dom: CollectionType?): LookupElement? {
        val meta = dom
            ?.module
            ?.project

...
class LeSExtensionLineMarkerProvider : AbstractLeSLineMarkerProvider<XmlAttributeValue>() {
    ...
    override fun collectDeclarations(psi: XmlAttributeValue): Collection<RelatedItemLineMarkerInfo<PsiElement>> {
        val leaf = psi.childrenOfType<XmlToken>()
            ...
            ?: return emptyList()
        if (PsiTreeUtil.getParentOfType(psi, XmlTag::class.java)?.localName != Extensions.EXTENSION) return emptyList()
        ...
        val marker = NavigationGutterIconBuilder
            ...
            .setPopupTitle(message("hybris.editor.gutter.les.extension.popup.title"))
            .setTooltipText(message("hybris.editor.gutter.les.extension.tooltip.text"))

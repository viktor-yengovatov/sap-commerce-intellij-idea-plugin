...
open class CngActionDefinitionCompletionProvider : CompletionProvider<CompletionParameters>() {
    ...
    companion object {
        val instance: CompletionProvider<CompletionParameters> =
            ApplicationManager.getApplication().getService(CngActionDefinitionCompletionProvider::class.java)
    }
}
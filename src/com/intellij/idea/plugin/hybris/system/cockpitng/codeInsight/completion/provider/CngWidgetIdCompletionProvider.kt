...
open class CngWidgetIdCompletionProvider : CompletionProvider<CompletionParameters>() {
    ...
    companion object {
        val instance: CompletionProvider<CompletionParameters> =
            ApplicationManager.getApplication().getService(CngWidgetIdCompletionProvider::class.java)
    }
}
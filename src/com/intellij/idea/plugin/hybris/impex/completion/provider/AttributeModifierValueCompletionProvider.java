 ...
 */
public class AttributeModifierValueCompletionProvider extends CompletionProvider<CompletionParameters> {

    private static final CompletionProvider<CompletionParameters> INSTANCE = new AttributeModifierValueCompletionProvider();

    public static CompletionProvider<CompletionParameters> getInstance() {
        return INSTANCE;
    }

    protected AttributeModifierValueCompletionProvider() {
    }

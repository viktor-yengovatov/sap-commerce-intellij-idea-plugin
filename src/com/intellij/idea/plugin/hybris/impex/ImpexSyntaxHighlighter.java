...
public class ImpexSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
        if (tokenType.equals(ImpexTypes.SEPARATOR)) {
            return SEPARATOR_KEYS;
        } else if (tokenType.equals(ImpexTypes.KEY)) {
            return KEY_KEYS;
        } else if (tokenType.equals(ImpexTypes.VALUE)) {
            return VALUE_KEYS;
        } else if (tokenType.equals(ImpexTypes.COMMENT)) {
            return COMMENT_KEYS;

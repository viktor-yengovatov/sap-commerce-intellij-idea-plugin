...
class ImpExFileHeaderInstaller : HybrisFileHeaderInstaller(
    ...
    companion object {
        val instance: ImpExFileHeaderInstaller = ApplicationManager.getApplication().getService(ImpExFileHeaderInstaller::class.java)
    }
}
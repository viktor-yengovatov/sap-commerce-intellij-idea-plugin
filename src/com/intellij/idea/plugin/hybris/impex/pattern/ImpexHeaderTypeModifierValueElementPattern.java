 ...
 */
public class ImpexHeaderTypeModifierValueElementPattern implements ElementFilter {

    private static final ElementFilter INSTANCE = new ImpexHeaderTypeModifierValueElementPattern();
    ...
    protected ImpexHeaderTypeModifierValueElementPattern() {
    }

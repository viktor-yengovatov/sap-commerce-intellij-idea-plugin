 ...
 */
public class ImpexHeaderAttributeModifierNameElementPattern implements ElementFilter {

    private static final ElementFilter INSTANCE = new ImpexHeaderAttributeModifierNameElementPattern();
    ...
    protected ImpexHeaderAttributeModifierNameElementPattern() {
    }

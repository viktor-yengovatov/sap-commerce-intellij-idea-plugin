...
public class LineSplitter implements Iterable<String>, Iterator<String> {
    ...
    public String next() {
        ...
        int winEof = notFormattedText.indexOf(ImpexTableParser.WIN_EOF, startIndex);
        int linuxEof = notFormattedText.indexOf(ImpexTableParser.LINUX_EOF, startIndex);
        ...
        if (winEof < 0 && linuxEof < 0) {
            ...
            endIndex = winEof;
            endOfLine = ImpexTableParser.WIN_EOF;
        } else {
            endIndex = linuxEof;
            endOfLine = ImpexTableParser.LINUX_EOF;
        }

...
import static com.intellij.idea.plugin.hybris.impex.tableFormatting.util.ImpexTableFormatterConstants.DEFAULT_DELIMITERS;
...
public class DelimitersCount {
    ...
    private Map<Character, Integer> counters = newHashMap();

 ...
 */
public class Idea15xVersionService implements VersionSpecificService {
    ...
    public Notification createNotification(
        ...
        return NotificationGroup.balloonGroup(displayId).createNotification(title, content, notificationType, null);
    }
}

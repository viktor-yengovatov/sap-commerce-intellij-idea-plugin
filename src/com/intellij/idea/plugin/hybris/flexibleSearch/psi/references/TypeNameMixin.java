...
public abstract class TypeNameMixin extends ASTWrapperPsiElement implements FlexibleSearchTableName {

    private TypeSystemItemReference myReference;

    public TypeNameMixin(@NotNull final ASTNode astNode) {
        super(astNode);
    }
    ...
    protected Object clone() {
        final TypeNameMixin result = (TypeNameMixin) super.clone();

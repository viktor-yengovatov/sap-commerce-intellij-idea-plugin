 ...
 */
public class CheckCompilerClearOutputDirectoryStep extends ProjectImportWizardStep {
    ...
    public CheckCompilerClearOutputDirectoryStep(final WizardContext context) {
        super(context);
    }

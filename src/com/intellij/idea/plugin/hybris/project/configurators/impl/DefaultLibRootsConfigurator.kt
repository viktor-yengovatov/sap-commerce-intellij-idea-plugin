        ...
        when (moduleDescriptor) {
            ...
            is YOotbRegularModuleDescriptor -> {
                if (moduleDescriptor.hasBackofficeModule) {
                    ...
                    if (backofficeJarDirectory.exists()) {
                        YModuleLibDescriptorUtil.addRootProjectLibrary(modifiableModelsProvider, backofficeJarDirectory, null, HybrisConstants.BACKOFFICE_LIBRARY_GROUP)
                    }
                }
            ...
            is YWebSubModuleDescriptor -> {
                if (moduleDescriptor.owner.name == HybrisConstants.EXTENSION_NAME_BACK_OFFICE) {
                    ...
                    YModuleLibDescriptorUtil.addRootProjectLibrary(modifiableModelsProvider, classes, null, HybrisConstants.BACKOFFICE_LIBRARY_GROUP, false)
                    YModuleLibDescriptorUtil.addRootProjectLibrary(modifiableModelsProvider, library, sources, HybrisConstants.BACKOFFICE_LIBRARY_GROUP)
                }
            }
        }
    }

...
class BeansMetaBeanNode(val parent: BeansNode, val meta: BeansGlobalMetaBean) : BeansNode(parent), Disposable {
    ...
    override fun update(project: Project, presentation: PresentationData) {
        ...
        presentation.setIcon(HybrisIcons.BEAN)
    ...
    override fun getChildren(): Collection<BeansNode?> {
        return meta.properties.values
            .filter { it.isCustom }
            .sortedBy { it.name }
            .map { BeansMetaPropertyNode(this, it) }
    }

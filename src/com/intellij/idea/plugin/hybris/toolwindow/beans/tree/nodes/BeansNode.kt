...
abstract class BeansNode : PresentableNodeDescriptor<BeansNode?>, Supplier {
    protected constructor(project: Project) : super(project, null)
    protected constructor(parent: BeansNode) : super(parent.project, parent)
    ...
    open fun getChildren(): Collection<BeansNode?> = emptyList()

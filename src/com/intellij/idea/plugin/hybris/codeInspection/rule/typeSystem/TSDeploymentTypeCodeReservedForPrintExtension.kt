...
class TSDeploymentTypeCodeReservedForPrintExtension : AbstractCustomOnlyTSInspection() {
    ...
    private fun check(
        ...
        if (typeCode != null && typeCode in HybrisConstants.TS_TYPECODE_RANGE_PRINT) {

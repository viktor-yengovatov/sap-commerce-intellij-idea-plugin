...
class TSDeploymentTypeCodesMustBeGreaterThanTenThousandForRelations : AbstractCustomOnlyTSInspection() {
    ...
    override fun inspect(
        ...
        dom.relations.relations.forEach { check(it.deployment, project, holder, severity) }
    }

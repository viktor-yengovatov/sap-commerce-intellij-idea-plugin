...
abstract class AbstractEiSInspection : DomElementsInspection<ExtensionInfo>(ExtensionInfo::class.java) {

    override fun checkFileElement(domFileElement: DomFileElement<ExtensionInfo>, holder: DomElementAnnotationHolder) {

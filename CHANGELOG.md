...
- Some classes are not visible from `storefrontcommons` if searchable class is in read-only storefrontcommons  [#593](https://github.com/epam/sap-commerce-intellij-idea-plugin/pull/593)
